...
* EB samples look more heterogeneous - in particular, measurements from the BN allele in the BF/FB cross look quite different than those from the other strain in the same cross, as well as the same strain in the other cross  
...
There are `r sum(res_EPC$adj.P.Val < 0.05)` significant hits in EB.
