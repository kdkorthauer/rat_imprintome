...
2. those that don't satisfy: RPKM >= 0.5 (total from maternal and paternal allele) in at least 2 out of 5 or 6 reps in *either* cross in *either* tissue (i.e. required to have 2 reps each for *either* cross in *either* EB or EPC) 
